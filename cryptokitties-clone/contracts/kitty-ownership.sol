...
import "./kitty-base.sol";

//// ERC721Draft.sol 상속은 KittyBase에서 받고 있으므로 삭제
...
contract KittyOwnership is KittyBase {
    ...
    //// KittyBase에서 ERC721Enumerable을 상속하기 때문에 KittyBase에서 생성자 세팅
    // string public name = "CryptoKitties";
    // string public symbol = "CK";

    //// ERC721 양식을 따르는지 체크
    //// ERC721Enumerable의 supportsInterface로 대체
    ...
    function _owns(
        ...
        //// KittyBase에서 kittyIndexToOwner를 ERC721 표준 내용으로 대체
        /// ERC721 ownerOf() 함수로 대체
        // return kittyIndexToOwner[_tokenId] == _claimant;
        address owner = ownerOf(_tokenId);
        return (_claimant == owner);
    }

    //// 기존 transferFrom()에서 사용된 함수
    //// 기존 transferFrom()이 ERC721의 transferFrom()으로 대체되어 삭제
    ...
    //// ERC721 표준 베타버전의 양식이었으나 표준이 정립되며 삭제
    //// 현재 ERC721 표준에는 safeTransferFrom()과 transferFrom()만 존재
    //// ClockAuction에서 사용되던 transfer()는 safeTransferFrom()으로 대체
    ...
    //// ERC721Enumerable의 totalSupply()로 대체
    ...
    //// ERC721Enumerable의 tokenOfOwnerByIndex()로 대체
